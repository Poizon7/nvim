...
_G.packer_plugins = {
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/v/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["lsp_lines.nvim"] = {
    loaded = true,
    path = "/home/v/.local/share/nvim/site/pack/packer/start/lsp_lines.nvim",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/v/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
    url = "https://github.com/JoosepAlviste/nvim-ts-context-commentstring"
  },
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/v/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["rust-tools.nvim"] = {
    loaded = true,
    path = "/home/v/.local/share/nvim/site/pack/packer/start/rust-tools.nvim",
